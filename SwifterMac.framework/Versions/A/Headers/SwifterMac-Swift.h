...
@property (nonatomic) void (^ uploadProgressHandler)(NSInteger, NSInteger, NSInteger);
@property (nonatomic) void (^ downloadProgressHandler)(NSData *, NSInteger, NSInteger, NSHTTPURLResponse *);
@property (nonatomic) void (^ successHandler)(NSData *, NSHTTPURLResponse *);
@property (nonatomic) void (^ failureHandler)(NSError *);
...
+ (NSData *)mulipartContentWithBounday:(NSString *)boundary data:(NSData *)data fileName:(NSString *)fileName parameterName:(NSString *)parameterName mimeType:(NSString *)mimeTypeOrNil;
